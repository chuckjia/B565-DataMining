...
IMG_HEIGHT = 256
IMG_CHANNELS = 3
TRAIN_PATH = '/home/iu_ai_club/Documents/chuckjia/datamining/data/stage1_train/'
TEST_PATH = '/home/iu_ai_club/Documents/chuckjia/datamining/data/stage1_test/'
...
for imgNo in range(len(X_test_id)):
    ...
    filename = os.path.join(imgFolder, str(imgNo) + '.png')
